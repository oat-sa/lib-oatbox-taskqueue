...
class InitRdsQueue extends \common_ext_action_InstallAction
{
    public function __invoke($params) {
        ...
        try {
            ...
            $queueTable->addColumn(RdsQueue::QUEUE_TYPE, "string",array("default" => null , "notnull" => false,"length" => 255));
            ...
            $queueTable->addColumn(RdsQueue::QUEUE_TASK, "text", array("default" => null, "notnull" => false));
